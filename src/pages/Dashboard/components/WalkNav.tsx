...
export default function WalkNav({ className }: React.HTMLAttributes<HTMLElement>) {
    ...
    const commonStyles = "underline-offset-8 decoration-blue-400 decoration-2 hover:bg-white " + (isLargeScreen ? "p-0 pr-4" : " flex-1");
    ...
    return (
        <div className={cn(className, "flex gap-4 p-1.5 bg-slate-100 rounded-lg lg:p-0 lg:bg-white")}>
            <Button
                variant={variant}
